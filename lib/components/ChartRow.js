...
var ChartRow = /** @class */ (function (_super) {
    ...
    function ChartRow(props) {
        ...
        _this.isChildYAxis = function (child) {
            return (0, react_hot_loader_1.areComponentsEqual)(child.type, YAxis_1["default"]) ||
    ...
    ChartRow.prototype.render = function () {
        ...
        react_1["default"].Children.forEach(this.props.children, function (child) {
            if (child === null)
                return;
            if ((0, react_hot_loader_1.areComponentsEqual)(child.type, Brush_1["default"]) ||
    ...
    ChartRow.propTypes = {
         ...
         */
        axisMargin: prop_types_1["default"].number,
        /**
         ...
         */
        trackerShowTime: prop_types_1["default"].bool,
        /**
         * The width of the tracker info box
         */
        trackerInfoWidth: prop_types_1["default"].number,
        /**
         * The height of the tracker info box
         */
        trackerInfoHeight: prop_types_1["default"].number,
        trackerStyle: prop_types_1["default"].any,
         ...
         */
        trackerInfoValues: prop_types_1["default"].oneOfType([
         ...
         */
        titleBoxStyle: prop_types_1["default"].object,
        children: prop_types_1["default"].oneOfType([prop_types_1["default"].arrayOf(prop_types_1["default"].node), prop_types_1["default"].node]),
        leftAxisWidths: prop_types_1["default"].arrayOf(prop_types_1["default"].number),
        rightAxisWidths: prop_types_1["default"].arrayOf(prop_types_1["default"].number),
        width: prop_types_1["default"].number,
        timeScale: prop_types_1["default"].func,
        trackerTimeFormat: prop_types_1["default"].oneOfType([prop_types_1["default"].string, prop_types_1["default"].func]),
        timeFormat: prop_types_1["default"].oneOfType([prop_types_1["default"].string, prop_types_1["default"].func]),
        trackerTime: prop_types_1["default"].instanceOf(Date)
    };
    return ChartRow;
