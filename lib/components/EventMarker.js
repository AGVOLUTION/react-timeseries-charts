...
var EventTime = function (_a) {
    ...
    var text;
    if (underscore_1["default"].isFunction(format)) {
        text = format(time);
    }
    else {
...
EventTimeRange.propTypes = {
    timerange: prop_types_1["default"].instanceOf(pondjs_1.TimeRange),
    format: prop_types_1["default"].any
};
...
EventIndex.propTypes = {
    index: prop_types_1["default"].instanceOf(pondjs_1.Index),
    format: prop_types_1["default"].any
};
/**
...
var EventMarker = /** @class */ (function (_super) {
    ...
    EventMarker.prototype.renderMarker = function (event, column, info) {
        ...
        var label;
        if (info) {
            if (underscore_1["default"].isString(this.props.info)) {
    ...
    EventMarker.propTypes = {
        type: prop_types_1["default"].oneOf(["point", "flag"]),
        /**
         * What [Pond Event](https://esnet-pondjs.appspot.com/#/event) to mark
         */
        event: prop_types_1["default"].oneOfType([
            prop_types_1["default"].instanceOf(pondjs_1.TimeEvent),
            prop_types_1["default"].instanceOf(pondjs_1.IndexedEvent),
            prop_types_1["default"].instanceOf(pondjs_1.TimeRangeEvent)
        ]),
        /**
         ...
         */
        info: prop_types_1["default"].oneOfType([
         ...
         */
        infoTimeFormat: prop_types_1["default"].any,
        /**
         * Show a label to the left or right of the marker
         */
        markerLabelAlign: prop_types_1["default"].oneOf(["left", "right", "top", "bottom"]),
        markerLabel: prop_types_1["default"].any,
        markerLabelStyle: prop_types_1["default"].any,
        marker: prop_types_1["default"].string,
        /**
         ...
         */
        yValueFunc: prop_types_1["default"].func,
        /**
         * Offset the marker position in the x direction.
         */
        offsetX: prop_types_1["default"].number,
        /**
         * Offset the marker position in the y direction
         */
        offsetY: prop_types_1["default"].number,
        /**
        ...
        stemStyle: prop_types_1["default"].any
    };
