...
var MultiBrush = /** @class */ (function (_super) {
    ...
    MultiBrush.propTypes = {
        ...
        timeRanges: prop_types_1["default"].any,
        /**
         ...
         */
        allowFreeDrawing: prop_types_1["default"].bool,
        /**
         ...
         */
        onUserMouseUp: prop_types_1["default"].func,
        /**
         * When the user clicks one of the TimeRanges
         */
        onTimeRangeClicked: prop_types_1["default"].func,
        /**
