...
const defaultTimeAxisStyle: any = {
    axis: {
        fill: "none",
        stroke: "#C0C0C0",
        pointerEvents: "none"
...
const defaultChartRowTitleLabelStyle: any = {
    fontWeight: 100,
    fontSize: 13,
    font: '"Goudy Bookletter 1911", sans-serif"',
    fill: "#000"
...
const defaultChartRowTitleBoxStyle: any = {
    fill: "white",
    stroke: "none"
};
 ...
 * ```
 */
export default class ChartContainer extends React.Component<InferProps<typeof ChartContainer.propTypes>> {
    rightWidth: any;
    leftWidth: any;
    timeScale: any;
    svg: any;
    ...
    render() {
        ...
        React.Children.forEach(this.props.children, (childRow:any) => {
            if (areComponentsEqual(childRow.type, ChartRow)) {
                ...
                React.Children.forEach(childRow.props.children, (child: any) => {
